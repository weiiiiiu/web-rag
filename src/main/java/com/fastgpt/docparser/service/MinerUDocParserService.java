...
public class MinerUDocParserService {
    ...
    public MinerUDocParserService(MinerUProperties minerUProperties, FileProperties fileProperties) {
    ...
    public ParserResult parseToMarkdown(Path filePath) {
        try {
            ...
            // 返回结果，包含 markdown 和解压目录
            return ParserResult.ofMinerU(markdownContent, extractDir);
